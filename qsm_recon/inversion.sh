...
TEMP_FOLDER=/scr/tee2/schaefer/tmp/
OUTPUT=QSM.nii
WINKEL=-25.9
maskeverschieben=yes ### yes/no

bet $BILD_MAG brain -m -f 0.1
/home/raid/schaefer/processing.static/siemens_phase $BILD_PHASE $TEMP_FOLDER/rad_$BILD_PHASE 

### place everything in cubic matrix
### original matrix: (x y z) 208 256 160
/home/raid/scha
efer/processing.static/place_in_new_matrix $ORGMASK 350 350 350 $TEMP_FOLDER/newmat_$ORGMASK
/home/raid/schaefer/processing.static/place_in_new_matrix $BILD_MAG 350 350 350 $TEMP_FOLDER/newmat_$BILD_MAG
/home/raid/schaefer/processing.static/place_in_new_matrix $TEMP_FOLDER/rad_$BILD_PHASE 350 350 350 $TEMP_FOLDER/newmat_$BILD_PHASE
...
/home/raid/schaefer/processing.static/create_mask $TEMP_FOLDER/result.nii 1 1000 $TEMP_FOLDER/result.nii
...
/home/raid/schaefer/processing.static/place_in_new_matrix $TEMP_FOLDER/result.nii  208 256 160 $outfile
fi
...
/home/raid/schaefer/processing.static/place_in_new_matrix $outfile 350 350 350 $TEMP_FOLDER/newmat_$outfile

/home/raid/schaefer/processing.static/SDI $TEMP_FOLDER/newmat_$BILD_PHASE 2 0.00005 $TEMP_FOLDER/newmat_$outfile $TEMP_FOLDER/newmat
...
/home/raid/schaefer/processing.static/fit_sph_harm 2 $TEMP_FOLDER/newmat_sharp.nii $TEMP_FOLDER/newmat_$outfile $TEMP_FOLDER/newmat_sharp_plus_pol

/home/raid/schaefer/processing.static/from_phase_to_susc_1angle2 $WINKEL $TEMP_FOLDER/newmat_sharp_plus_pol_filtered.nii 1.99 $OUTPUT

### back to right geometry 
/home/raid/schaefer/processing.static/place_in_new_matrix $OUTPUT 208 256 160 $OUTPUT
micalc -noscale -if1 $OUTPUT -op '*' -if2 $outfile -of $OUTPUT
fslcpgeom $BILD_MAG $OUTPUT

/home/raid/schaefer/processing.static/place_in_new_matrix $TEMP_FOLDER/newmat_sharp_plus_pol_filtered.nii 208 256 160 sharp_plus_pol_filtered.nii
